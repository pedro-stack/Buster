...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    .setColor(Color)
    .setTitle(`Music <a:797855362694774804:891459284183941170>`)
    .setThumbnail(client.user.displayAvatarURL())
    ...
    .setColor(Color)
    .setTitle(`Info <a:797855362694774804:891459284183941170>`)
    .setThumbnail(client.user.displayAvatarURL())
