...
let rowss = new MessageActionRow()
                ...
                if (serverQueue) {
                    ...
                    if (playlist) return undefined;
                        ...
                        const sembed = new MessageEmbed()
                            .setColor("GREEN")
                            .setTitle("<:ItemMusicNote:891215369279270913> Added To Queue", message.author.displayAvatarURL())
  ...
  const serverQueue = ops.queue.get(message.guild.id);
                ...
                const embed = new MessageEmbed()
                    .setColor("GREEN")
                    .setTitle('<:ItemMusicNote:891215369279270913> Started Playing')
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setImage("https://cdn.discordapp.com/attachments/779341728695451678/897772426086215680/standard_22.gif")
                    ...
                    .setColor("GREEN")
                    .setTitle('<:ItemMusicNote:891215369279270913> Song was Ended')
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setDescription(`**<a:778521981468540960:891240754993844244>Title:** [${song.title}](${song.url}) \n\n **<a:logo:897774100712407050>Song Duration** ${np} minutes \n\n **Status:** **Finished** `)
                    .setFooter(`Played by: ${message.member.displayName} `, message.author.displayAvatarURL());
